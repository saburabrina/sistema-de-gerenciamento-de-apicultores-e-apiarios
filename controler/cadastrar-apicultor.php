<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  if($certificao == 'outra'){
	  	$certificacao = test_input($_POST["outra-certificacao"]);
	  }
	  ...
	  header('Location: ../views/cadastrar-apicultor.php');
	}
