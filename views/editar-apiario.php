                ...
                <div class="card-body">
                  <form method="post" action="../controler/editar-apiario.php">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <select name="florada" id="florada" class="custom-select">
                            <?php
                              echo $apiarios[$_GET['apiario']]->getTipoFlorada();

                              if($apiarios[$_GET['apiario']]->getTipoFlorada() == 'eucalipto'){
                                echo'
                              ...
                              } else if($apiarios[$_GET['apiario']]->getTipoFlorada() == 'laranjeira') {
                                echo'
                                <option value="eucalipto">Eucalipto</option>
                                <option value="laranjeira" selected>Laranjeira Silvestre</option>
                                <option value="silveste">Lavoura</option>
                                <option value="outro">Outro</option>';
                              } else if($apiarios[$_GET['apiario']]->getTipoFlorada() == 'silvestre') {
                                echo'
                                <option value="eucalipto">Eucalipto</option>
                                <option value="laranjeira">Laranjeira Silvestre</option>
                    ...
                    <div class="row">                      
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input class="form-control" type="text" id="outra-florada" name="outra-florada" value="<?php echo $apiarios[$_GET['apiario']]->getTipoFlorada(); ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <input type="hidden" id="propriedade" name="propriedade" value="<?php echo $apiarios[$_GET['apiario']]->getPropriedade()->getId(); ?>"> 
