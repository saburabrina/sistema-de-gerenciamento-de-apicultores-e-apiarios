          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form methos="post" action="../controler/cadastrar-tratamento.php">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="doenca" name="doenca" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">                 
                      <div class="col-lg-9">
                        <div class="form-group">
                          ...
                          <input type="text" id="forma-dosagem" name="forma-dosagem" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          ...
                          <input type="number" id="quantidade-doses" name="quantidade-doses" class="form-control">
                        </div>
                      </div>
                    </div>

                    <input type="hidden" id="caixa" name="caixa" value="<?php echo $caixas[$_GET['caixa']]->getId(); ?>">
