...
<head>
  ...
  <title>Apiários e Propriedades</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="busca-por-caixa.php">Caixa</a>
          </div>
        </div>
      </li>
                ...
                <div class="card-body">
                  <form method="post" action="../controler/buscar-por-caixa.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-1">
                          <input type="checkbox" id="check-melgueiras" name="check-melgueiras">
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="melgueiras">Número de Melgueiras</label>
                          <input type="number" id="melgueiras" name="melgueiras" class="form-control" onClick="selecionarCheck('check-melgueiras')">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-1">
                          <input type="checkbox" id="check-local-extracao" name="check-local-extracao">
                      </div>
                      <div class="col-lg-5">
                        <div class="form-group">
                          <label for="local-extracao">Local de Extração</label>
                          <input type="text" id="local-extracao" name="local-extracao" class="form-control" onClick="selecionarCheck('check-local-extracao')">
                        </div>
                      </div>
                    </div>
                    ...
                    if(isset($_SESSION['caixas'])){
                      ...
                      if(count($caixas) > 0){
                        ...
                        for($i=0; $i<count($caixas); $i++){
                          ...
                          echo '<tr><td>' . $caixas[$i]->getId() .'</td><td>' . $caixas[$i]->getApiario()->getNome() . '</td><td>' . $caixas[$i]->getMaterial() . '</td><td>' . $caixas[$i]->getMelgueiras() . '</td><td>' . $caixas[$i]->getLocalExtracao() . '</td><td><a href="editar-caixa.php?caixa=' . $i . '" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pencil-alt"></i></a> <td><button class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#removerCaixa"><i class="fas fa-times"></i></button></td></tr>';
                        }
          ...
          <?php
            if(isset($_SESSION['caixas'])){
              ...
              if(count($caixas) > 0){
                for($i=0; $i<count($caixas); $i++){
                  echo '
                  <div class="modal fade" id="removerCaixa' . $i .'" >
                    <div class="modal-dialog">
                      <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Remover Caixa</h5>
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>

                        <!-- Modal body -->
                        <div class="modal-body">
                          Clique em "Remover" abaixo se você deseja remover a caixa dos registros
                        </div>
                        <!-- Modal footer -->
                        <div class="modal-footer">
                          <a href="../controler/remover-caixa.php" class="btn btn-danger" data-dismiss="modal">Remover</a>
                        </div>
