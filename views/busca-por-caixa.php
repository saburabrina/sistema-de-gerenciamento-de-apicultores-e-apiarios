...
<head>
  ...
  <title>Buscar Caixa - Apiários e Propriedades</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="busca-por-medicao.php">Caixa</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="../controler/logout.php" data-toggle="modal" data-target="#logoutModal">
                  ...
                  if($_SESSION['erro']){
                    ...
                    echo '
                      <div class="alert alert-danger" role="alert">
                        Houve um erro ao tentar remover a caixa
                      </div>
                    ';
                  }
                ...
                <div class="card-body">
                  <form method="post" action="../controler/buscar-por-caixa.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2">
                        <div class="form-group">
                          <label for="melgueiras">Melgueiras</label>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="../controler/remover-caixa.php?caixa=' . $i . '" class="btn btn-danger">Remover</a>
                        </div>
