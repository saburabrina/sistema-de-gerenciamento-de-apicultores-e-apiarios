          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/cadastrar-fumegador.php">
                    ...
                    <input type="hidden" id="apicultor" name="apicultor" value="<?PHP echo $apicultores[$_GET['apicultor']]->getCpf(); ?>"> 
