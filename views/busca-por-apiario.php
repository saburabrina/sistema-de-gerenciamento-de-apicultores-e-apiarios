    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cadastrar-caixa.php">Caixa</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="busca-por-apiario.php">Apiário</a>
                    ...
                    if(isset($_SESSION['apiarios'])){
                      ...
                      if(count($apiarios) > 0){
                        ...
                        for($i=0; $i<count($apiarios); $i++){
                          ...
                          echo '<tr><td>' . $apiarios[$i]->getNome() .'</td><td>$apiarios[$i]->getDono()</td><td>' . $endereco . '</td><td>' . $apiarios[$i]->getInscricaoEstadual() . '<td><a href="editar-apiario.php?apiario=' . $i . '" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pencil-alt"></i></a> <td><button class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#removerApiario"><i class="fas fa-times"></i></button></td></tr>';
                        }
          ...
          <?php
            if(isset($_SESSION['apiarios'])){
              ...
              if(count($apiarios) > 0){
                for($i=0; $i<count($apiarios); $i++){
                  echo '
                  <div class="modal fade" id="removerApiario' . $i .'" >
                    <div class="modal-dialog">
                      <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Remover Apiário</h5>
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>

                        <!-- Modal body -->
                        <div class="modal-body">
                          Clique em "Remover" abaixo se você deseja remover o apiário dos registros
                        </div>
                        <!-- Modal footer -->
