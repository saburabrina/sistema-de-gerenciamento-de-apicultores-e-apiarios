                    ...
                    if($_SESSION['status']){
                      echo '
                        <div class="alert alert-success" role="alert">
                          Produção Anual cadastrada com sucesso
                        </div>
                      ';
                    } else {
                      echo '
                        <div class="alert alert-danger" role="alert">
                          A produção anual não pôde ser cadastrada
                        </div>
                      ';
                    }
          ...
          <div class="row">
            <div class="offset-2 col-lg-8">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/buscar-apicultor-para-cadastrar-producao.php">
