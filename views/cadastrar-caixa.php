          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form methos="post" action="../controler/cadastrar-caixa.php">
                    ...
                    <div class="row">
                      <div class="col-lg-5">
                        <div class="form-group">
                          ...
                          <input type="number" id="melgueiras" name="melgueiras" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="local-extracao" name="local-extracao" class="form-control">
                        </div>
                      </div>
                    </div>

                    <h6 class="m-0 font-weight-bold text-primary">Informações da Colméia</h6>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="date" id="data-troca" name="data-troca" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" name="submit" class="btn btn-success btn-block">Cadastrar</button>
                  </form>
                </div>
              </div>
            </div>
