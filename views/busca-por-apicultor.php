...
<head>
  ...
  <title>Buscar Apicultor - Apicultores e Materiais</title>
                  ...
                  if($_SESSION['status']){
                    echo '
                      <div class="alert alert-success" role="alert">
                        O registro do apicultor foi alterado com sucesso
                      </div>
                    ';
                  } else {
                    echo '
                      <div class="alert alert-danger" role="alert">
                        O registro do apicultor não pôde ser alterado
                      </div>
                    ';
                  }
                  ...
                  <?php
                    if(isset($_SESSION['apicultores'])){
                      ...
                      if(count($apicultores) > 0){
                        echo '<div class="card shadow h-100 py-2 mt-2"><div class="card-body"><div class="table-responsive"><table class="table" id="dataTable" width="100%" cellspacing="0"><thead><tr><th>CPF</th><th>Nome</th><th>Email</th><th> Telefone</th><th>Endereço</th><th>Certificação</th><th>Perfil</th><th>Vínculo</th><th>Ações</th></tr></thead><tfoot><tr><th>CPF</th><th>Nome</th><th>Email</th><th> Telefone</th><th>Endereço</th><th>Certificação</th><th>Perfil</th><th>Vínculo</th><th>Ações</th></tr></tfoot><tbody>';
          ...
          <?php
            if(isset($_SESSION['apicultores'])){
              ...
              if(count($apicultores) > 0){
                for($i=0; $i<count($apicultores); $i++){
                  echo '
                  <div class="modal fade" id="removerApicultor' . $i .'" >
                    <div class="modal-dialog">
                      <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Remover Apicultor</h5>
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>

                        <!-- Modal body -->
                        <div class="modal-body">
                          Clique em "Remover" abaixo se você deseja remover o apicultor dos registros
                        </div>
                        <!-- Modal footer -->
