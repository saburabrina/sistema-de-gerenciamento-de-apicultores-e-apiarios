...
<head>
  ...
  <title>Buscar Produção - Produção</title>
                  ...
                  if($_SESSION['erro']){
                    echo '
                      <div class="alert alert-success" role="alert">
                        Produção removida com sucesso
                      </div>
                    ';
                  } else {
                    echo '
                      <div class="alert alert-danger" role="alert">
                        Houve um erro ao tentar remover a produção
                      </div>
                    ';
                  }
                  ...
                  <?php
                    if(isset($_SESSION['producoes'])){
                      ...
                      if(count($producoes) > 0){
                        echo '<div class="card shadow h-100 py-2 mt-2"><div class="card-body"><div class="table-responsive"><table class="table" id="dataTable" width="100%" cellspacing="0"><thead><tr><th>Apiário</th><th>Rótulo</th><th>Destino</th><th>Tipo</th><th>Material</th><th>Ações</th></tr></thead><tfoot><tr><th>ID</th><th>Apiário</th><th>Rótulo</th><th>Destino</th><th>Tipo</th><th>Material</th><th>Ações</th></tr></tfoot><tbody>';

                        for($i=0; $i<count($producoes); $i++){

                          echo '<tr><td>' . $producoes[$i]->getApiario()->getNome() .'</td><td>' . $producoes[$i]->getRotulo() . '</td><td>' . $producoes[$i]->getDestino() . '</td><td>' . $producoes[$i]->getTipo() . '</td><td>' . $producoes[$i]->getMaterial() . '</td><td><a href="editar-producao.php?producao=' . $i . '" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pencil-alt"></i></a> <button class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#removerProducao"><i class="fas fa-times"></i></button></td></tr>';
                        }
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="../controler/remover-producao.php?producao=' . $i . '" class="btn btn-danger" data-dismiss="modal">Remover</a>
                        </div>
