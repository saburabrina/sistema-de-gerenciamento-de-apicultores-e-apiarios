...
<head>
  ...
  <title>Cadastrar Tratamento Veterinário - Controles Veterinários e Tratamentos</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="buscar-apiario-para-cadastrar-controle.php">Controle Veterinário</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="busca-por-controle.php">Controle Veterinário</a>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="apiario">Nome do Apiario</label>
                          <input type="text" id="apiario" name="apiario" class="form-control">
                        </div>
                      </div>
                    </div>
