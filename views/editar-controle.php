          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form methos="post" action="../controler/editar-controle.php">
                    ...
                    <div class="row">
                      <div class="col-lg-5">
                        <div class="form-group">
                          ...
                          <input type="date" id="data" name="data" class="form-control" value="<?php echo $controles[$_GET['controle']]->getDataExame(); ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="nome-veterinario" name="nome-veterinario" class="form-control" value="<?php echo $controles[$_GET['controle']]->getNomeVeterinario(); ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="crmv" name="crmv" class="form-control" value="<?php echo $controles[$_GET['controle']]->getCrmvVeterinario(); ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="condicao-veterinaria" name="condicao-veterinaria" class="form-control" value="<?php echo $controles[$_GET['controle']]->getCondicaoVeterinaria(); ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <?php 
                      $amostras = $controles[$_GET['controle']]->getAmostras();

                      for($i=0; $i<count($amostras); $i++){
                        echo '
                        <h6 class="m-0 font-weight-bold text-secondary text-center mb-3">Amostra'. $i + 1 . '</h6>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
