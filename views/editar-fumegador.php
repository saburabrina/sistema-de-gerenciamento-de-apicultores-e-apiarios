...
<head>
  ...
  <title>Editar Fumegador - Apicultores e Materiais</title>
          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/editar-fumegador.php">

                    <div class="form-group">
                      <label for="produto">Produto Utilizado</label>
                      <input type="text" id="produto" name="produto" class="form-control" value="<?php echo $fumegadores[$_GET['fumegador']]->getProdutoUtilizado(); ?>">
                    </div>

                    <input type="hidden" id="apicultor" name="apicultor" value="<?php echo $fumegadores[$_GET['fumegador']]->getApicultor(); ?>"> 
