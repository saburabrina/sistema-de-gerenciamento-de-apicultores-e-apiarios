                ...
                <div class="card-body">
                  <form method="post" action="../controler/editar-fumegador.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="produto" name="produto" class="form-control" value="<?php echo $fumegadores[$_GET['fumegador']]->getProduto(); ?>">
                    </div>

                    <input type="text" id="apicultor" name="apicultor" value="<?php echo $fumegadores[$_GET['fumegador']]->getApicultor(); ?>"> 
