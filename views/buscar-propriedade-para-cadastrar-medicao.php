                  ...
                  if($_SESSION['status']){
                    echo '
                      <div class="alert alert-success" role="alert">
                        Medição Climática cadastrado com sucesso
                      </div>
                    ';
                  } else {
                    echo '
                      <div class="alert alert-danger" role="alert">
                        A medição climática não pôde ser cadastrado
                      </div>
                    ';
                  }
                  ...
                  <?php
                    if(isset($_SESSION['propriedades'])){
                      ...
                      if(count($propriedades) > 0){
                        echo '<div class="card shadow h-100 py-2 mt-2"><div class="card-body"><div class="table-responsive"><table class="table" id="dataTable" width="100%" cellspacing="0"><thead><tr><th>ID</th><th>Endereço</th><th>Área Destinada</th></tr></thead><tfoot><tr><th>ID</th><th>Endereço</th><th>Área Destinada</th></tr></tfoot><tbody>';
                        ...
                        for($i=0; $i<count($propriedades); $i++){
                          ...
                          echo '<tr><td>' . $propriedades[$i]->getId() .'</td><td>' . $endereco . '</td><td>' . $propriedades[$i]->getAreaDestinada() . '</td><td><a href="cadastrar-medicao.php?propriedade=' . $i . '" class="btn btn-success btn-circle btn-sm"><i class="fas fa-plus"></i></a></td></tr>';
                        }
