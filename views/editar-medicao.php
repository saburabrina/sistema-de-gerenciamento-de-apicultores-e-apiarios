...
<head>
  ...
  <title>Editar Medição Climática</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="busca-por-medicao.php">Medição Climática</a>
          </div>
        </div>
      </li>
          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/editar-medicao.php">

                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="data">Data da Medição</label>
                          <input type="date" id="data" name="data" class="form-control" value="<?php echo $medicoes[$_GET['medicao']]->getData(); ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="temperatura" name="temperatura" class="form-control" value="<?php echo $medicoes[$_GET['medicao']]->getTemperatura(); ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="umidade" name="umidade" class="form-control" value="<?php echo $medicoes[$_GET['medicao']]->getUmidade(); ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="precipitacao" name="precipitacao" class="form-control" value="<?php echo $medicoes[$_GET['medicao']]->getPrecipitacao(); ?>">
                        </div>
                      </div>
                    </div>

                    <input type="hidden" id="propriedade" name="propriedade" value="<?php echo $medicoes[$_GET['medicao']]->getPropriedade()->getId(); ?>"> 
