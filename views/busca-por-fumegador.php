...
<head>
  ...
  <title>Buscar Fumegador - Apicultores e Materiais</title>
                  ...
                  if($_SESSION['erro']){
                    echo '
                      <div class="alert alert-success" role="alert">
                        Fumegador removido com sucesso
                      </div>
                    ';
                  } else {
                    echo '
                      <div class="alert alert-danger" role="alert">
                        Houve um erro ao tentar remover o fumegador
                      </div>
                    ';
                  }
                  ...
                  <?php
                    if(isset($_SESSION['fumegadores'])){
                      ...
                      if(count($fumegadores) > 0){
                        echo '<div class="card shadow h-100 py-2 mt-2"><div class="card-body"><div class="table-responsive"><table class="table" id="dataTable" width="100%" cellspacing="0"><thead><tr><th>Apicultor</th><th>Produto Utilizado</th><th>Ações</th></tr></thead><tfoot><tr><th>Apicultor</th><th>Produto Utilizado</th><th>Ações</th></tr></tfoot><tbody>';
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="../controler/remover-fumegador.php?fumegador=' . $i . '" class="btn btn-danger">Remover</a>
                        </div>
