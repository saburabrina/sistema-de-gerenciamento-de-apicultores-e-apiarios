          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/cadastrar-medicao.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="umidade" name="umidade" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="precipitacao" name="precipitacao" class="form-control">
                        </div>
                      </div>
                    </div>
