    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cadastrar-fumegador.php">Fumegador</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#">Apicultor</a>
            <a class="collapse-item" href="#">Material</a>
          </div>
        </div>
      </li>
          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form methos="post" action="../controler/editar-apicultor.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="cep" name="id" class="form-control" value="<?php if($apicultores[$_GET['apicultor']]->getEndereco() != null) {echo $apicultores[$_GET['apicultor']]->getEndereco()->getCep(); }?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-10">
                        <div class="form-group">
                          ...
                          <input type="text" id="logradouroPropriedade" name="logadouroPropriedade" class="form-control" value="<?php if($apicultores[$_GET['apicultor']]->getTrabalhaEm() != null) {echo $apicultores[$_GET['apicultor']]->getTrabalhaEm()->getLogradouro(); }?>">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="cepPropriedade" name="cepPropriedade" class="form-control" value="<?php if($apicultores[$_GET['apicultor']]->getTrabalhaEm() != null) {echo $apicultores[$_GET['apicultor']]->getTrabalhaEm()->getCpf(); }?>">
                        </div>
                      </div>
                    </div>
