...
<head>
  ...
  <title>Cadastrar Controle Veterinário - Controle Veterinário e Tratamentos</title>
          ...
          <div class="row">
            <div class="offset-2 col-lg-8">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/buscar-apiario-para-cadastrar-controle.php">
