                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="material" name="material" class="form-control" class="form-control" value="<?php echo $caixas[$_GET['caixa']]->getMaterial(); ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="local-extracao" name="local-extracao" class="form-control" class="form-control" value="<?php echo $caixas[$_GET['caixa']]->getLocalExtracao(); ?>">
                        </div>
                      </div>
                    </div>
