      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="buscar-propriedade-para-cadastrar-medicao.php">Medição Climática</a>
          </div>
        </div>
      </li>
          ...
          <div class="row">
            <div class="offset-lg-3 col-lg-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <form method="post" action="../controler/cadastrar-apiario.php">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="dono" name="dono" class="form-control">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="date" id="data-fundacao" name="data-fundacao">
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input class="form-control" type="text" id="outra-florada" name="outra-florada">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="number" id="caixas-povoadas" name="caixas-povoadas" class="form-control">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="caixas-vazias">Caixas Vazias</label>
                          <input type="number" id="caixas-vazias" name="caixas-vazias" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <input type="hidden" id="propriedade" name="propriedade" value="<?php echo $propriedades[$_GET['propriedade']]->getId(); ?>"> 
